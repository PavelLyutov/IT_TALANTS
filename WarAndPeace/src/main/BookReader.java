...
public class BookReader {
    TreeMap<String ,Integer > mostCommon = new TreeMap<String, Integer>();
    File f ;
    int numberOfRows=0;
    int numberOfWords=0;
    ...
    FileNotFoundException e) {
     ...
     int countPeace(String word){
        if(word.equals("мир") || word.equals("мирът") || word.equals("мира")){
            return 1;
        }else {
            return 0;
        }
     ...
     void writeAllWordsToFiles(TreeMap<String,Integer> treeMap) {
        ...
        for (Map.Entry<String, Integer> entry : entriesSortedByValues(treeMap)
            ...
            int countLetters = entry.getKey().length();
            String fileName = countLetters + "letters.txt";
