...
public class Shipment implements Comparable<Shipment> {
    ...
    public boolean equals(Object o) {
        ...
        return packageId == shipment.packageId &&
                dockId == shipment.dockId &&
                craneId == shipment.craneId &&
                Objects.equals(shipName, shipment.shipName) &&
                Objects.equals(shipmentTime, shipment.shipmentTime);
    }
    ...
    public String toString() {
        return "пратка "+packageId+", кораб „"+shipName+"“, кран "+craneId+", " + shipmentTime;
    }
}
